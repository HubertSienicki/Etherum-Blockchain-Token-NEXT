...
contract('NEXT_Token_Sale', function (accounts) {
    ...
    it('facilitates token buying', function () {
        return NEXTToken.deployed().then(function (instance) {
            ...
            assert.equal(receipt.logs[0].args._amount, numberOfTokens, 'logs the number of tokens puchased')
            return tokenSaleInstance.tokensSold();
        }).then(function(amount){
            assert.equal(amount.toNumber(), numberOfTokens, 'evaluates the numberOfTokens sold')
